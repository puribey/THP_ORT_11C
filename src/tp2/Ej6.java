...
public class Ej6 {
	...
	public static void main(String[] args) {
		...
		/* Mientras la cantidad de alumnos ingresada sea menor a 10, ejecutar el codigo siguiente */
		while(contadorAlumnos < 10) {
            ...
            /* Checkear si el promedio es superior al mejor y si lo es guardar promedio y nombre*/
